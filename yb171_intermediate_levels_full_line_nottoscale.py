...
st.title("171Yb⁺ hyperfine levels – intermediate B (matrix diagonalization) - not to scale")
...
all_manifolds = ["^2S_1/2", "^2P_1/2", "^2P_3/2", "^2D_3/2", "^3[3/2]_1/2", "^2D_5/2", "^1[3/2]_3/2", "^2F_7/2", "^1[5/2]_5/2"]
...
if not selected_manifolds:
    ...
    with col_left:
        ...
        fig.update_layout(
            title=f"171Yb⁺ hyperfine levels at B = {B_plot:.1f} G (color = mF), y valus is not correct, please refer to the right transition calculation",
    ...
    #with st.expander("Inspect a single eigenstate (basis decomposition)", expanded=False):
        ...
        manifolds_for_inspect = ["^2S_1/2", "^2P_1/2", "^2P_3/2", "^2D_3/2", "^3[3/2]_1/2", "^2D_5/2", "^1[3/2]_3/2", "^2F_7/2", "^1[5/2]_5/2"]
