...
sr87_data = {
    "5S1/2": {
        ...
        "gI": -131.7712e-6,               # gI = mu_I*(1-sigma)/mu_B from the experiement data : Phys. Rev. Lett. 135, 193001 – Published 3 November, 2025
...
# ----------------------------------------------------------
st.subheader("Sr⁺ Parameter Table (from sr87_data)")
